...
inquirer
  .prompt([
    ...
    {
      type:"list",
      message: "What is the position the employee will fill?",
      name: "empPosition",
      choices: employees,
      loop: false,
    },
    {
      type:"list",
      message: "Which employees are also managers?",
      name: "empManager",
      choices: managers,
      loop: false,
    }
...
inquirer
  .prompt([
    ...
    {
      type:"list",
      message: "Which new role will be assigned to the employee?",
      name: "roleEmpUpdates",
      choices: roleUpdates,
      loop: false,
    }
